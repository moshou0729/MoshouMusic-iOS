...
const handleGetMusicUrl = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (source, musicInfo, quality) {
  ...
  return function handleGetMusicUrl(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

// ====== 获取歌词 ======
const handleGetLyric = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (source, musicInfo) {
    const params = collectMusicInfoParams(musicInfo, source);
    params.action = 'lyric';
    try {
      const query = Object.entries(params).filter(([, v]) => v !== undefined && v !== null && v !== '').map(([k, v]) => k + '=' + encodeURIComponent(String(v))).join('&');
  ...
  return function handleGetLyric(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();

// ====== 获取封面 ======
const handleGetPic = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(function* (source, musicInfo) {
    const params = collectMusicInfoParams(musicInfo, source);
    params.action = 'pic';
    try {
      const query = Object.entries(params).filter(([, v]) => v !== undefined && v !== null && v !== '').map(([k, v]) => k + '=' + encodeURIComponent(String(v))).join('&');
  ...
  return function handleGetPic(_x6, _x7) {
